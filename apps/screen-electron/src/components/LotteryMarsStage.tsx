...
const DEFAULT_PRIZE_CONFIG: PrizeConfig[] = [
  { id: 'prize-1', name: '一等奖', item: '精美礼品', totalCount: 1, drawTurns: 1, isActive: true },
  { id: 'prize-2', name: '二等奖', item: '精美礼品', totalCount: 3, drawTurns: 1, isActive: true },
  { id: 'prize-3', name: '三等奖', item: '精美礼品', totalCount: 10, drawTurns: 2, isActive: true }
];
